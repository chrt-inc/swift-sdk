...
```swift
dependencies: [
    .package(url: "https://github.com/chrt-inc/swift-sdk", from: "1.341.19"),
]
```
...
let request = Requests.CreateCheckoutSessionReq(
    ...
)
```
...
```swift
try await client.payments.createCheckoutSessionV1(..., requestOptions: .init(
    additionalHeaders: [
