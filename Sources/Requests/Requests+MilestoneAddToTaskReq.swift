...
extension Requests {
    public struct MilestoneAddToTaskReq: Codable, Hashable, Sendable {
        ...
        public let completerComments: Nullable<String>?
        ...
        public init(
            taskId: String,
            completerComments: Nullable<String>? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.completerComments = try container.decodeNullableIfPresent(String.self, forKey: .completerComments)
        ...
        public func encode(to encoder: Encoder) throws -> Void {
            ...
            try container.encodeNullableIfPresent(self.completerComments, forKey: .completerComments)
