...
extension Requests {
    public struct MilestoneAddToTaskReq: Codable, Hashable, Sendable {
        ...
        public let completerComments: JSONValue?
        ...
        public init(
            taskId: String,
            completerComments: JSONValue? = nil,
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.completerComments = try container.decodeIfPresent(JSONValue.self, forKey: .completerComments)
