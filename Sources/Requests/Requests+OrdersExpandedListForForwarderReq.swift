...
extension Requests {
    public struct OrdersExpandedListForForwarderReq: Codable, Hashable, Sendable {
        ...
        public let shipperOrgIdsInclude: [String]?
        public let shipperOrgIdsExclude: [String]?
        ...
        public init(
            ...
            shipperOrgIdsInclude: [String]? = nil,
            shipperOrgIdsExclude: [String]? = nil,
            ...
            self.shipperOrgIdsInclude = shipperOrgIdsInclude
            self.shipperOrgIdsExclude = shipperOrgIdsExclude
            self.status = status
            self.skip = skip
            self.limit = limit
        ...
        public init(from decoder: Decoder) throws {
            ...
            self.shipperOrgIdsInclude = try container.decodeIfPresent([String].self, forKey: .shipperOrgIdsInclude)
            self.shipperOrgIdsExclude = try container.decodeIfPresent([String].self, forKey: .shipperOrgIdsExclude)
        ...
        public func encode(to encoder: Encoder) throws -> Void {
            ...
            try container.encodeIfPresent(self.shipperOrgIdsInclude, forKey: .shipperOrgIdsInclude)
            try container.encodeIfPresent(self.shipperOrgIdsExclude, forKey: .shipperOrgIdsExclude)
        ...
        enum CodingKeys: String, CodingKey, CaseIterable {
            ...
            case shipperOrgIdsInclude = "shipper_org_ids_include"
            case shipperOrgIdsExclude = "shipper_org_ids_exclude"
            case status
            case skip
            case limit
        }
