...
public final class ImagesClient: Sendable {
    ...
    public func uploadByMilestoneId(milestoneId: String, comments: JSONValue? = nil, request: any Codable, requestOptions: RequestOptions? = nil) async throws -> Bool {
        return try await httpClient.performRequest(
            method: .post,
            path: "/oort/milestones/images/upload/\(milestoneId)",
            queryParams: [
                "comments": comments.map { .unknown($0) }
            ],
            body: request,
