...
public final class ShipperPayCourierLineItemGroupsRemoveLineItemsClient: Sendable {
    ...
    public func byId(id: String, request: ShipperPayCourierLineItemGroupRemoveLineItemsReq, requestOptions: RequestOptions? = nil) async throws -> ShipperPayCourierLineItemGroup1 {
