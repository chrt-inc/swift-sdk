...
public final class CargoByDriverClient: Sendable {
    ...
    public func lastSeenV1(cargoId: String, taskGroupId: String, requestOptions: RequestOptions? = nil) async throws -> TrackingCargoByDriverDataPoint1? {
        return try await httpClient.performRequest(
            ...
            responseType: TrackingCargoByDriverDataPoint1?.self
        )
    }
}