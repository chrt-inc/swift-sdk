...
public final class RemoveLineItemsClient: Sendable {
    ...
    public func byId(id: String, request: CourierPayDriverLineItemGroupRemoveLineItemsReq, requestOptions: RequestOptions? = nil) async throws -> CourierPayDriverLineItemGroup1 {
