...
public final class ChrtGroundProviderRateSheetsClient: Sendable {
    ...
    public func getByIdV1(id: String, requestOptions: RequestOptions? = nil) async throws -> ChrtGroundProviderRateSheet1 {
    ...
    ///
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func listV1(includeArchived: Bool? = nil, page: Int? = nil, pageSize: Int? = nil, requestOptions: RequestOptions? = nil) async throws -> ChrtGroundProviderRateSheetListRes {
        return try await httpClient.performRequest(
            method: .get,
            path: "/billing/chrt_ground_provider_rate_sheets/list/v1",
            queryParams: [
            ...
            requestOptions: requestOptions,
            responseType: ChrtGroundProviderRateSheetListRes.self
        )
    }
    ...
    public func unarchiveV1(id: String, requestOptions: RequestOptions? = nil) async throws -> Bool {
        return try await httpClient.performRequest(
            method: .patch,
            path: "/billing/chrt_ground_provider_rate_sheets/unarchive/v1/\(id)",
            requestOptions: requestOptions,
            responseType: Bool.self
        )
    }
