...
public final class CargoClient: Sendable {
    ...
    public func addV1(request: Requests.OrderDraftAddCargoReq, requestOptions: RequestOptions? = nil) async throws -> String {
        return try await httpClient.performRequest(
            method: .post,
            path: "/shipping/orders/drafts/cargo/add/v1",
            body: request,
    ...
    public func associateWithTaskV1(request: Requests.OrderDraftAssociateCargoWithTaskReq, requestOptions: RequestOptions? = nil) async throws -> Bool {
        return try await httpClient.performRequest(
            method: .post,
            path: "/shipping/orders/drafts/cargo/associate_with_task/v1",
            body: request,
            requestOptions: requestOptions,
    ...
    public func unassociateWithTaskV1(request: Requests.OrderDraftUnassociateCargoWithTaskReq, requestOptions: RequestOptions? = nil) async throws -> Bool {
        return try await httpClient.performRequest(
            method: .post,
            path: "/shipping/orders/drafts/cargo/unassociate_with_task/v1",
            body: request,
            requestOptions: requestOptions,
            responseType: Bool.self
        )
    ...
    public func updateV1(request: Requests.OrderDraftUpdateCargoReq, requestOptions: RequestOptions? = nil) async throws -> String {
        return try await httpClient.performRequest(
            method: .patch,
            path: "/shipping/orders/drafts/cargo/update/v1",
            body: request,
            requestOptions: requestOptions,
            responseType: String.self
        )
