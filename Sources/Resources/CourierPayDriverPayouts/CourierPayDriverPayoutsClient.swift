...
public final class CourierPayDriverPayoutsClient: Sendable {
    ...
    ///
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func create(request: CourierPayDriverPayoutClientCreate1, requestOptions: RequestOptions? = nil) async throws -> String {
        return try await httpClient.performRequest(
            method: .post,
    ...
    ///
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func updateStatus(id: String, request: CourierPayDriverPayoutClientUpdate1, requestOptions: RequestOptions? = nil) async throws -> CourierPayDriverPayout1 {
        return try await httpClient.performRequest(
            method: .patch,
