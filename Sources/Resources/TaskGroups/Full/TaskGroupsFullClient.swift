...
public final class TaskGroupsFullClient: Sendable {
    ...
    public func listByCourierOrgId(requestOptions: RequestOptions? = nil) async throws -> MultipleTaskGroupsDetailsResponse {
        return try await httpClient.performRequest(
            method: .get,
            path: "/oort/task_groups/by_courier_org_id/list/full",
    ...
    ///
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func getByTaskGroupId(id: String, requestOptions: RequestOptions? = nil) async throws -> TaskGroupWithDetails {
        return try await httpClient.performRequest(
            method: .get,
            path: "/oort/task_groups/\(id)/full",
            requestOptions: requestOptions,
