...
public final class Ontime360OrdersClient: Sendable {
    ...
    /// ```
    ///
    /// - Parameter providerOrgId: CHRT org ID of the courier whose OnTime360 site holds the order
    /// - Parameter integrationOrderId: OnTime360's own GUID for the order (its ID), as carried on a unified order row
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func detailByIntegrationOrderIdV1(providerOrgId: String, integrationOrderId: String, requestOptions: RequestOptions? = nil) async throws -> OnTime360Order1 {
        return try await httpClient.performRequest(
            method: .get,
            path: "/shipping_integrations/ontime360/orders/by_integration_order_id/detail/v1/\(providerOrgId)/\(integrationOrderId)",
    ...
    /// ```
    ///
    /// - Parameter id: Mongo ObjectId of the mirror document. OnTime360's own order GUID is the integration_order_id, accepted by the by_integration_order_id route.
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func detailV1(id: String, requestOptions: RequestOptions? = nil) async throws -> OnTime360Order1 {
        return try await httpClient.performRequest(
            method: .get,
            path: "/shipping_integrations/ontime360/orders/detail/v1/\(id)",
            requestOptions: requestOptions,
            responseType: OnTime360Order1.self
        )
    }
    ...
    public func listV1(sortBy: OnTime360OrderSortByEnum? = nil, sortOrder: SortOrderEnum? = nil, page: Int? = nil, pageSize: Int? = nil, search: String? = nil, filterProviderOrgId: [String]? = nil, filterIntegrationOrderId: String? = nil, filterProviderStatusLevel: OnTime360StatusLevelEnum1? = nil, filterMirroredAtTimestampGte: Date? = nil, filterMirroredAtTimestampLte: Date? = nil, filterCreatedAtTimestampGte: Date? = nil, filterCreatedAtTimestampLte: Date? = nil, filterUpdatedAtTimestampGte: Date? = nil, filterUpdatedAtTimestampLte: Date? = nil, requestOptions: RequestOptions? = nil) async throws -> OnTime360OrderListRes {
        return try await httpClient.performRequest(
            ...
            requestOptions: requestOptions,
            responseType: OnTime360OrderListRes.self
        )
    }
    ...
    ///
    /// - Parameter requestOptions: Additional options for configuring the request, such as custom headers or timeout settings.
    public func syncOneV1(request: Requests.OnTime360OrderSyncOneReq, requestOptions: RequestOptions? = nil) async throws -> OnTime360Order1 {
        return try await httpClient.performRequest(
            method: .post,
            path: "/shipping_integrations/ontime360/orders/sync_one/v1",
            body: request,
            requestOptions: requestOptions,
            responseType: OnTime360Order1.self
        )
