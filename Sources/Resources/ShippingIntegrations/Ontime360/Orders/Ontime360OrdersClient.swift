...
public final class Ontime360OrdersClient: Sendable {
    ...
    public func detailByIntegrationOrderIdV1(orgId: String, integrationOrderId: String, requestOptions: RequestOptions? = nil) async throws -> OnTime360Order1 {
        return try await httpClient.performRequest(
            method: .get,
            path: "/shipping_integrations/ontime360/orders/by_integration_order_id/detail/v1/\(orgId)/\(integrationOrderId)",
