...
public struct OrgBiddingGroupListItemRes: Codable, Hashable, Sendable {
    ...
    public let providers: [OrgPublicData1]?
    ...
    public init(
        ...
        ownerOrgId: String,
        providerOrgIds: [String]? = nil,
        providers: [OrgPublicData1]? = nil,
        schemaVersion: Int,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.providerOrgIds = try container.decodeIfPresent([String].self, forKey: .providerOrgIds)
        self.providers = try container.decodeIfPresent([OrgPublicData1].self, forKey: .providers)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encodeIfPresent(self.providerOrgIds, forKey: .providerOrgIds)
