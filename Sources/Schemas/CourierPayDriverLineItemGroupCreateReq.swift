...
public struct CourierPayDriverLineItemGroupCreateReq: Codable, Hashable, Sendable {
    ...
    public init(
        courierPayDriverRateSheetId: String,
        taskGroupId: String,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.courierPayDriverRateSheetId = try container.decode(String.self, forKey: .courierPayDriverRateSheetId)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encode(self.courierPayDriverRateSheetId, forKey: .courierPayDriverRateSheetId)
