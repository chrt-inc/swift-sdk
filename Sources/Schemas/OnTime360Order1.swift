...
public struct OnTime360Order1: Codable, Hashable, Sendable {
    ...
    public let providerPayload: OnTime360OrderResponse1
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.providerPayload = try container.decode(OnTime360OrderResponse1.self, forKey: .providerPayload)
