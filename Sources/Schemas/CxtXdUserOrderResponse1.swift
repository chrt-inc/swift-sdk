...
/// Direct CXT order detail returned by ``GET /Dispatch/Orders/{orderId}``.
public struct CxtXdUserOrderResponse1: Codable, Hashable, Sendable {
    ...
    public let drivers: [[String: JSONValue]]?
    public let fleet: [String: JSONValue]?
    public let flightInfo: JSONValue?
    ...
    public let hasAuthorizedCreditCard: Bool?
    ...
    public let signature: JSONValue?
    ...
    public init(
        ...
        distance: Double? = nil,
        drivers: [[String: JSONValue]]? = nil,
        fleet: [String: JSONValue]? = nil,
        flightInfo: JSONValue? = nil,
        forceLocationScanDelivery: String? = nil,
        forceLocationScanPickup: String? = nil,
        hasAssociatedRouteStops: Bool? = nil,
        hasAuthorizedCreditCard: Bool? = nil,
        id: String,
        isParent: Bool? = nil,
        ...
        self.hasAuthorizedCreditCard = hasAuthorizedCreditCard
        self.id = id
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.drivers = try container.decodeIfPresent([[String: JSONValue]].self, forKey: .drivers)
        self.fleet = try container.decodeIfPresent([String: JSONValue].self, forKey: .fleet)
        self.flightInfo = try container.decodeIfPresent(JSONValue.self, forKey: .flightInfo)
        ...
        self.hasAuthorizedCreditCard = try container.decodeIfPresent(Bool.self, forKey: .hasAuthorizedCreditCard)
        ...
        self.signature = try container.decodeIfPresent(JSONValue.self, forKey: .signature)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encodeIfPresent(self.flightInfo, forKey: .flightInfo)
        ...
        try container.encodeIfPresent(self.hasAuthorizedCreditCard, forKey: .hasAuthorizedCreditCard)
