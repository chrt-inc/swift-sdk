...
public struct AtlasOrderExpanded1: Codable, Hashable, Sendable {
    ...
    public let providerPayload: AtlasOrderResponse1
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.providerPayload = try container.decode(AtlasOrderResponse1.self, forKey: .providerPayload)
