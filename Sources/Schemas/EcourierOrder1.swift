...
public struct EcourierOrder1: Codable, Hashable, Sendable {
    ...
    public let providerPayload: EcourierOrderResponse1
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.providerPayload = try container.decode(EcourierOrderResponse1.self, forKey: .providerPayload)
