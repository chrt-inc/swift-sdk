...
public struct TaskGroupExpanded: Codable, Hashable, Sendable {
    ...
    public let executorDepartments: [Department1]?
    ...
    public init(
        ...
        driver: Driver1? = nil,
        executorDepartments: [Department1]? = nil,
        ...
        self.driver = driver
        self.executorDepartments = executorDepartments
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.executorDepartments = try container.decodeIfPresent([Department1].self, forKey: .executorDepartments)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encodeIfPresent(self.executorDepartments, forKey: .executorDepartments)
    ...
    enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case driver
        case executorDepartments = "executor_departments"
