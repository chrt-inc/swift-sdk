...
public struct TrackingCargoByDeviceDataPoint1: Codable, Hashable, Sendable {
    public let schemaVersion: Int
    public let timestamp: Date
    public let metadata: TrackingCargoByDeviceDataPointMetadata1
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.metadata = try container.decode(TrackingCargoByDeviceDataPointMetadata1.self, forKey: .metadata)
