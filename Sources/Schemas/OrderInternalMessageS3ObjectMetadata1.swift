...
public struct OrderInternalMessageS3ObjectMetadata1: Codable, Hashable, Sendable {
    ...
    public let s3KeyPrefix: OperationsOrderInternalMessageS3ObjectMetadata?
    ...
    public init(
        ...
        s3KeyPrefix: OperationsOrderInternalMessageS3ObjectMetadata? = nil,
        schemaVersion: Int,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.s3KeyPrefix = try container.decodeIfPresent(OperationsOrderInternalMessageS3ObjectMetadata.self, forKey: .s3KeyPrefix)
    ...
    public enum OperationsOrderInternalMessageS3ObjectMetadata: String, Codable, Hashable, CaseIterable, Sendable {
        case operationsOrderInternalMessageS3ObjectMetadata = "operations/order_internal_message_s3_object_metadata"
    }
