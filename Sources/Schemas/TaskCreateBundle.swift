...
public struct TaskCreateBundle: Codable, Hashable, Sendable {
    ...
    public init(
        ...
        milestoneClientCreates: Nullable<[MilestoneClientCreate1]>? = nil,
        cargoClientCreatesUuids: Nullable<[String]>? = nil,
        emailAddresses: Nullable<[String]>? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.milestoneClientCreates = try container.decodeNullableIfPresent([MilestoneClientCreate1].self, forKey: .milestoneClientCreates)
        self.cargoClientCreatesUuids = try container.decodeNullableIfPresent([String].self, forKey: .cargoClientCreatesUuids)
        self.emailAddresses = try container.decodeNullableIfPresent([String].self, forKey: .emailAddresses)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encodeNullableIfPresent(self.milestoneClientCreates, forKey: .milestoneClientCreates)
        try container.encodeNullableIfPresent(self.cargoClientCreatesUuids, forKey: .cargoClientCreatesUuids)
        try container.encodeNullableIfPresent(self.emailAddresses, forKey: .emailAddresses)
