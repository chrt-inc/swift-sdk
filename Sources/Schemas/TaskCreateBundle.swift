...
public struct TaskCreateBundle: Codable, Hashable, Sendable {
    ...
    public init(
        ...
        milestoneClientCreates: JSONValue? = nil,
        cargoClientCreatesUuids: JSONValue? = nil,
        emailAddresses: JSONValue? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.milestoneClientCreates = try container.decodeIfPresent(JSONValue.self, forKey: .milestoneClientCreates)
        self.cargoClientCreatesUuids = try container.decodeIfPresent(JSONValue.self, forKey: .cargoClientCreatesUuids)
        self.emailAddresses = try container.decodeIfPresent(JSONValue.self, forKey: .emailAddresses)
