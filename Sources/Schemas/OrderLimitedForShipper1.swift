...
/// Shipper view: coordinator operational fields hidden; task groups reduced
/// to shared executor identifiers.
public struct OrderLimitedForShipper1: Codable, Hashable, Sendable {
