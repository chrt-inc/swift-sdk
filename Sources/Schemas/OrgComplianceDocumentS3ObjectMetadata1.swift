...
public struct OrgComplianceDocumentS3ObjectMetadata1: Codable, Hashable, Sendable {
    ...
    public let orgComplianceDocumentId: String
    public let s3KeyPrefix: OrgsOrgComplianceDocumentS3ObjectMetadata?
    ...
    public init(
        ...
        s3KeyPrefix: OrgsOrgComplianceDocumentS3ObjectMetadata? = nil,
        schemaVersion: Int,
        ...
        self.orgComplianceDocumentId = orgComplianceDocumentId
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.orgComplianceDocumentId = try container.decode(String.self, forKey: .orgComplianceDocumentId)
        self.s3KeyPrefix = try container.decodeIfPresent(OrgsOrgComplianceDocumentS3ObjectMetadata.self, forKey: .s3KeyPrefix)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encode(self.orgComplianceDocumentId, forKey: .orgComplianceDocumentId)
    ...
    public enum OrgsOrgComplianceDocumentS3ObjectMetadata: String, Codable, Hashable, CaseIterable, Sendable {
        case orgsOrgComplianceDocumentS3ObjectMetadata = "orgs/org_compliance_document_s3_object_metadata"
    }
    ...
    enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case filename
        case orgComplianceDocumentId = "org_compliance_document_id"
