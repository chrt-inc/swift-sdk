...
public struct CourieOrder1: Codable, Hashable, Sendable {
    ...
    public let providerPayload: CourieOrderResponse1
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.providerPayload = try container.decode(CourieOrderResponse1.self, forKey: .providerPayload)
