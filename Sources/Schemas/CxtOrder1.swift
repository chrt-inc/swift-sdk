...
public struct CxtOrder1: Codable, Hashable, Sendable {
    ...
    public let providerPayload: CxtOrder1ProviderPayload
    ...
    public init(
        ...
        providerPayload: CxtOrder1ProviderPayload,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.providerPayload = try container.decode(CxtOrder1ProviderPayload.self, forKey: .providerPayload)
