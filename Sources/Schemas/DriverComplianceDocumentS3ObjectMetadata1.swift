...
public struct DriverComplianceDocumentS3ObjectMetadata1: Codable, Hashable, Sendable {
    ...
    public init(
        ...
        s3KeyPrefix: ShippingDriverComplianceDocumentS3ObjectMetadata? = nil,
        blurhash: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.s3KeyPrefix = try container.decodeIfPresent(ShippingDriverComplianceDocumentS3ObjectMetadata.self, forKey: .s3KeyPrefix)
    ...
    public enum ShippingDriverComplianceDocumentS3ObjectMetadata: String, Codable, Hashable, CaseIterable, Sendable {
        case shippingDriverComplianceDocumentS3ObjectMetadata = "shipping/driver_compliance_document_s3_object_metadata"
    }
