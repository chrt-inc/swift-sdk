...
public struct OrderExpandedForExecutor: Codable, Hashable, Sendable {
    ...
    public let order: OrderLimitedForExecutor1
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.order = try container.decode(OrderLimitedForExecutor1.self, forKey: .order)
