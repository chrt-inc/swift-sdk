...
public struct OrgMembersAndDrivers: Codable, Hashable, Sendable {
    public let driver: DriverWithActiveTaskGroupIds1?
    public let orgMember: OrgMemberDetails
    /// Additional properties that are not explicitly defined in the schema
    public let additionalProperties: [String: JSONValue]

    public init(
        driver: DriverWithActiveTaskGroupIds1? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.driver = try container.decodeIfPresent(DriverWithActiveTaskGroupIds1.self, forKey: .driver)
