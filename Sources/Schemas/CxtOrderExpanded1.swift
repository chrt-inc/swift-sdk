...
public struct CxtOrderExpanded1: Codable, Hashable, Sendable {
    ...
    public let providerPayload: CxtOrderExpanded1ProviderPayload
    public let providerPayloadHash: String
    public let schemaVersion: Int
    public let shippingIntegration: Cxt
    ...
    public init(
        ...
        providerPayload: CxtOrderExpanded1ProviderPayload,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.providerPayload = try container.decode(CxtOrderExpanded1ProviderPayload.self, forKey: .providerPayload)
        self.providerPayloadHash = try container.decode(String.self, forKey: .providerPayloadHash)
        self.schemaVersion = try container.decode(Int.self, forKey: .schemaVersion)
        self.shippingIntegration = try container.decode(Cxt.self, forKey: .shippingIntegration)
    ...
    public enum Cxt: String, Codable, Hashable, CaseIterable, Sendable {
        case cxt
    }
