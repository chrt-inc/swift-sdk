...
public struct DispatchScienceOrder1: Codable, Hashable, Sendable {
    ...
    public let providerPayload: DispatchScienceOrderResponse1
    public let providerPayloadHash: String
    public let schemaVersion: Int
    public let shippingIntegration: DispatchScience
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.providerPayload = try container.decode(DispatchScienceOrderResponse1.self, forKey: .providerPayload)
        self.providerPayloadHash = try container.decode(String.self, forKey: .providerPayloadHash)
        self.schemaVersion = try container.decode(Int.self, forKey: .schemaVersion)
        self.shippingIntegration = try container.decode(DispatchScience.self, forKey: .shippingIntegration)
    ...
    public enum DispatchScience: String, Codable, Hashable, CaseIterable, Sendable {
        case dispatchScience = "dispatch_science"
    }
