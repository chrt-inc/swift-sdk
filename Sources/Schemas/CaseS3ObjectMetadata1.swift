...
public struct CaseS3ObjectMetadata1: Codable, Hashable, Sendable {
    ...
    public let s3KeyPrefix: OperationsCaseS3ObjectMetadata?
    ...
    public init(
        ...
        s3KeyPrefix: OperationsCaseS3ObjectMetadata? = nil,
        blurhash: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.s3KeyPrefix = try container.decodeIfPresent(OperationsCaseS3ObjectMetadata.self, forKey: .s3KeyPrefix)
    ...
    public enum OperationsCaseS3ObjectMetadata: String, Codable, Hashable, CaseIterable, Sendable {
        case operationsCaseS3ObjectMetadata = "operations/case_s3_object_metadata"
    }
