...
public struct AdditionalMileageRate1: Codable, Hashable, Sendable {
    public let endsAtTotalDistanceMiles: Double
    ...
    public init(
        endsAtTotalDistanceMiles: Double,
        ratePerMile: Double,
        sageItemId: String? = nil,
        startsAtTotalDistanceMiles: Double,
        additionalProperties: [String: JSONValue] = .init()
    ) {
        self.endsAtTotalDistanceMiles = endsAtTotalDistanceMiles
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.endsAtTotalDistanceMiles = try container.decode(Double.self, forKey: .endsAtTotalDistanceMiles)
    ...
    public func encode(to encoder: Encoder) throws -> Void {
        ...
        try container.encode(self.endsAtTotalDistanceMiles, forKey: .endsAtTotalDistanceMiles)
    ...
    enum CodingKeys: String, CodingKey, CaseIterable {
        case endsAtTotalDistanceMiles = "ends_at_total_distance_miles"
