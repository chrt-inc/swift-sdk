...
@Suite("InvoiceLineItemsClient Wire Tests") struct InvoiceLineItemsClientWireTests {
                  ...
                  "items": [
                    {
                      ...
                      "order_last_delivery_task_completed_at_timestamp": "2024-01-15T09:30:00Z",
        ...
        let expectedResponse = InvoiceLineItemExportListRes(
            items: [
                InvoiceLineItemExportListItem(
                    ...
                    orderLastDeliveryTaskCompletedAtTimestamp: Optional(try! Date("2024-01-15T09:30:00Z", strategy: .iso8601)),
    ...
    @Test func listV11() async throws -> Void {
        ...
        let expectedResponse = InvoiceLineItemListRes(
            items: [
                InvoiceLineItemExpandedListItem(
                    invoice: Optional(Invoice1(
                        id: "_id",
                        createdAtTimestamp: try! Date("2024-01-15T09:30:00Z", strategy: .iso8601),
                        createdByUserId: "created_by_user_id",
    ...
    @Test func revertCurrencyConversionForOrdersV11() async throws -> Void {
        let stub = HTTPStub()
        stub.setResponse(
            body: Foundation.Data(
                #"""
                [
                  {
                    ...
                    "order_id": "order_id",
                    "status": "succeeded",
                    "unmatched_invoice_line_item_ids": [
                      "unmatched_invoice_line_item_ids"
                    ]
                  }
                ]
        ...
        let expectedResponse = [
            InvoiceLineItemsCurrencyConversionForOrdersRes(
                ...
                unmatchedInvoiceLineItemIds: Optional([
                    "unmatched_invoice_line_item_ids"
                ])
            )
        ]
        let response = try await client.billingNew.invoiceLineItems.revertCurrencyConversionForOrdersV1(
            request: .init(
                invoiceType: .accountsReceivable,
                orderIds: [
                    "order_ids"
    ...
    @Test func updateCurrencyConversionForOrdersV11() async throws -> Void {
        let stub = HTTPStub()
        stub.setResponse(
            body: Foundation.Data(
                #"""
        ...
        let response = try await client.billingNew.invoiceLineItems.updateCurrencyConversionForOrdersV1(
            request: .init(
                conversionRate: 1.1,
                invoiceType: .accountsReceivable,
                orderIds: [
