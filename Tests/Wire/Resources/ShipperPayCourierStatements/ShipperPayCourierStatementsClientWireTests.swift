...
@Suite("ShipperPayCourierStatementsClient Wire Tests") struct ShipperPayCourierStatementsClientWireTests {
    @Test func getByIdV11() async throws -> Void {
        ...
        let response = try await client.shipperPayCourierStatements.getByIdV1(
            shipperPayCourierStatementId: "shipper_pay_courier_statement_id",
    ...
    @Test func deleteV11() async throws -> Void {
        ...
        let response = try await client.shipperPayCourierStatements.deleteV1(
            shipperPayCourierStatementId: "shipper_pay_courier_statement_id",
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
        try #require(response == expectedResponse)
    ...
    @Test func getByOrderIdOrShortIdV11() async throws -> Void {
        ...
        let response = try await client.shipperPayCourierStatements.getByOrderIdOrShortIdV1(
    ...
    @Test func listByShipperOrgIdV11() async throws -> Void {
        ...
        let expectedResponse = GetShipperPayCourierStatementsForShipperRes(
            statements: [
        ...
        let response = try await client.shipperPayCourierStatements.listByShipperOrgIdV1(
    ...
    @Test func listByCourierOrgIdV11() async throws -> Void {
        ...
        let response = try await client.shipperPayCourierStatements.listByCourierOrgIdV1(
            request: .init(statuses: [
                .invoiceNotYetCreated
            ]),
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
    ...
    @Test func createV11() async throws -> Void {
        ...
        let response = try await client.shipperPayCourierStatements.createV1(
    ...
    @Test func previewV11() async throws -> Void {
        ...
        let expectedResponse = StatementPreviewResponse(
            taskGroups: [
                TaskGroup1(
                    schemaVersion: 1,
                    id: "_id",
        ...
        let response = try await client.shipperPayCourierStatements.previewV1(
            request: CreateShipperPayCourierStatementReq(
                orderIdOrShortId: "order_id_or_short_id"
            ),
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
