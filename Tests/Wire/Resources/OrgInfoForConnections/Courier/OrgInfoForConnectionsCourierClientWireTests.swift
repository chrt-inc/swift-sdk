...
@Suite("OrgInfoForConnectionsCourierClient Wire Tests") struct OrgInfoForConnectionsCourierClientWireTests {
    @Test func getV11() async throws -> Void {
        ...
        let response = try await client.orgInfoForConnections.courier.getV1(requestOptions: RequestOptions(additionalHeaders: stub.headers))
    ...
    @Test func listV11() async throws -> Void {
        ...
        let response = try await client.orgInfoForConnections.courier.listV1(requestOptions: RequestOptions(additionalHeaders: stub.headers))
        try #require(response == expectedResponse)
    }
    ...
    @Test func createV11() async throws -> Void {
        ...
        let response = try await client.orgInfoForConnections.courier.createV1(
            request: .init(
                schemaVersion: 1,
                emailAddressPrimary: "email_address_primary"
            ),
    ...
    @Test func updateV11() async throws -> Void {
        ...
        let response = try await client.orgInfoForConnections.courier.updateV1(
            request: .init(),
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
        try #require(response == expectedResponse)
