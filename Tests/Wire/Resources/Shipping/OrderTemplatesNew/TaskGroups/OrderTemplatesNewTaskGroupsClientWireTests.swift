...
@Suite("OrderTemplatesNewTaskGroupsClient Wire Tests") struct OrderTemplatesNewTaskGroupsClientWireTests {
    @Test func putReorderV11() async throws -> Void {
        ...
        let response = try await client.shipping.orderTemplatesNew.taskGroups.putReorderV1(
    ...
    @Test func postCreateV11() async throws -> Void {
        ...
        let response = try await client.shipping.orderTemplatesNew.taskGroups.postCreateV1(
            orderTemplateId: "order_template_id",
    ...
    @Test func deleteV11() async throws -> Void {
        ...
        let response = try await client.shipping.orderTemplatesNew.taskGroups.deleteV1(
            orderTemplateId: "order_template_id",
            taskGroupKey: "task_group_key",
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
    ...
    @Test func patchUpdateV11() async throws -> Void {
        ...
        let response = try await client.shipping.orderTemplatesNew.taskGroups.patchUpdateV1(
            orderTemplateId: "order_template_id",
            taskGroupKey: "task_group_key",
            request: .init(),
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
