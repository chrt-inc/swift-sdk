...
@Suite("OrderTemplatesNewTaskArtifactsClient Wire Tests") struct OrderTemplatesNewTaskArtifactsClientWireTests {
    @Test func putMoveV11() async throws -> Void {
        ...
        let response = try await client.shipping.orderTemplatesNew.taskArtifacts.putMoveV1(
    ...
    @Test func putReorderV11() async throws -> Void {
        ...
        let response = try await client.shipping.orderTemplatesNew.taskArtifacts.putReorderV1(
            orderTemplateId: "order_template_id",
            taskKey: "task_key",
            request: .init(),
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
    ...
    @Test func deleteV11() async throws -> Void {
        ...
        let response = try await client.shipping.orderTemplatesNew.taskArtifacts.deleteV1(
            orderTemplateId: "order_template_id",
            taskArtifactKey: "task_artifact_key",
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
    ...
    @Test func patchUpdateV11() async throws -> Void {
        ...
        let response = try await client.shipping.orderTemplatesNew.taskArtifacts.patchUpdateV1(
            orderTemplateId: "order_template_id",
            taskArtifactKey: "task_artifact_key",
            request: .init(),
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
    ...
    @Test func postCreateV11() async throws -> Void {
        ...
        let response = try await client.shipping.orderTemplatesNew.taskArtifacts.postCreateV1(
            orderTemplateId: "order_template_id",
            taskKey: "task_key",
