...
@Suite("DraftsExpandedClient Wire Tests") struct DraftsExpandedClientWireTests {
    @Test func forCoordinatorOperatorsV11() async throws -> Void {
        ...
        let response = try await client.shipping.orders.drafts.expanded.forCoordinatorOperatorsV1(
            orderRef: "order_ref",
    ...
    @Test func forShipperOperatorsV11() async throws -> Void {
        ...
        let response = try await client.shipping.orders.drafts.expanded.forShipperOperatorsV1(
            orderRef: "order_ref",
            request: OrderAndTaskGroupExpandedReq(
