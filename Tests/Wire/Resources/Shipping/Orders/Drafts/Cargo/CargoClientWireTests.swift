...
@Suite("CargoClient Wire Tests") struct CargoClientWireTests {
    @Test func addV11() async throws -> Void {
        ...
        let response = try await client.shipping.orders.drafts.cargo.addV1(
            request: .init(
    ...
    @Test func associateWithTaskV11() async throws -> Void {
        ...
        let response = try await client.shipping.orders.drafts.cargo.associateWithTaskV1(
            request: .init(
                cargoId: "cargo_id",
                orderId: "order_id",
                taskId: "task_id"
    ...
    @Test func unassociateWithTaskV11() async throws -> Void {
        ...
        let expectedResponse = true
        let response = try await client.shipping.orders.drafts.cargo.unassociateWithTaskV1(
            request: .init(
                cargoId: "cargo_id",
                orderId: "order_id",
                taskId: "task_id"
    ...
    @Test func updateV11() async throws -> Void {
        ...
        let expectedResponse = "string"
        let response = try await client.shipping.orders.drafts.cargo.updateV1(
            request: .init(
                cargoId: "cargo_id",
