...
@Suite("TaskGroupClient Wire Tests") struct TaskGroupClientWireTests {
    @Test func addV11() async throws -> Void {
        ...
        let response = try await client.shipping.orders.drafts.taskGroup.addV1(
            request: .init(
                orderId: "order_id",
    ...
    @Test func addExecutorV11() async throws -> Void {
        ...
        let response = try await client.shipping.orders.drafts.taskGroup.addExecutorV1(
    ...
    @Test func removeDriverV11() async throws -> Void {
        ...
        let expectedResponse = true
        let response = try await client.shipping.orders.drafts.taskGroup.removeDriverV1(
            taskGroupId: "task_group_id",
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
        try #require(response == expectedResponse)
    ...
    @Test func removeExecutorV11() async throws -> Void {
        ...
        let expectedResponse = true
        let response = try await client.shipping.orders.drafts.taskGroup.removeExecutorV1(
            taskGroupId: "task_group_id",
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
        try #require(response == expectedResponse)
    ...
    @Test func setFlightInfoV11() async throws -> Void {
        ...
        let expectedResponse = true
        let response = try await client.shipping.orders.drafts.taskGroup.setFlightInfoV1(
            taskGroupId: "task_group_id",
    ...
    @Test func setRateSheetsV11() async throws -> Void {
        ...
        let expectedResponse = true
        let response = try await client.shipping.orders.drafts.taskGroup.setRateSheetsV1(
            taskGroupId: "task_group_id",
            request: .init(),
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
    ...
    @Test func setTaskOrderingV11() async throws -> Void {
        ...
        let expectedResponse = true
        let response = try await client.shipping.orders.drafts.taskGroup.setTaskOrderingV1(
            taskGroupId: "task_group_id",
    ...
    @Test func setVehicleTypeV11() async throws -> Void {
        ...
        let expectedResponse = true
        let response = try await client.shipping.orders.drafts.taskGroup.setVehicleTypeV1(
            taskGroupId: "task_group_id",
            request: .init(),
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
    ...
    @Test func updateDriverV11() async throws -> Void {
        ...
        let expectedResponse = true
        let response = try await client.shipping.orders.drafts.taskGroup.updateDriverV1(
            taskGroupId: "task_group_id",
