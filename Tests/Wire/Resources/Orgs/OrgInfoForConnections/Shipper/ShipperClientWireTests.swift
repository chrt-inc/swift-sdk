...
@Suite("ShipperClient Wire Tests") struct ShipperClientWireTests {
    @Test func createV11() async throws -> Void {
        ...
        let response = try await client.orgs.orgInfoForConnections.shipper.createV1(
            request: .init(
    ...
    @Test func updateV11() async throws -> Void {
        ...
        let response = try await client.orgs.orgInfoForConnections.shipper.updateV1(
            request: .init(),
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
        try #require(response == expectedResponse)
    ...
    @Test func getV11() async throws -> Void {
        ...
        let response = try await client.orgs.orgInfoForConnections.shipper.getV1(requestOptions: RequestOptions(additionalHeaders: stub.headers))
        try #require(response == expectedResponse)
    }
}