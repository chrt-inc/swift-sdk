...
@Suite("TaskGroupByDriverSharingClient Wire Tests") struct TaskGroupByDriverSharingClientWireTests {
    @Test func postSharingSettingsV11() async throws -> Void {
        ...
        let response = try await client.tracking.taskGroupByDriverSharing.postSharingSettingsV1(
            request: .init(
                taskGroupId: "task_group_id",
                driverId: "driver_id",
                public: true
