...
@Suite("CargoByDriverSharingClient Wire Tests") struct CargoByDriverSharingClientWireTests {
    @Test func postSharingSettingsV11() async throws -> Void {
        ...
        let response = try await client.tracking.cargoByDriverSharing.postSharingSettingsV1(
            request: .init(
                taskGroupId: "task_group_id",
                cargoId: "cargo_id",
                driverId: "driver_id",
