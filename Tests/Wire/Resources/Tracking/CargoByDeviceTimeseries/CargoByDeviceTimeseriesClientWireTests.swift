...
@Suite("CargoByDeviceTimeseriesClient Wire Tests") struct CargoByDeviceTimeseriesClientWireTests {
    @Test func lastSeenV11() async throws -> Void {
        ...
        let response = try await client.tracking.cargoByDeviceTimeseries.lastSeenV1(
            cargoId: "cargo_id",
            taskGroupId: "task_group_id",
    ...
    @Test func dataPointsV11() async throws -> Void {
        ...
        let response = try await client.tracking.cargoByDeviceTimeseries.dataPointsV1(
            cargoId: "cargo_id",
            taskGroupId: "task_group_id",
            limit: 1,
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
    ...
    @Test func outlierV11() async throws -> Void {
        ...
        let response = try await client.tracking.cargoByDeviceTimeseries.outlierV1(
            request: .init(
    ...
    @Test func lastSeenPublicV11() async throws -> Void {
        ...
        let response = try await client.tracking.cargoByDeviceTimeseries.lastSeenPublicV1(
            cargoId: "cargo_id",
            taskGroupId: "task_group_id",
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
    ...
    @Test func dataPointsPublicV11() async throws -> Void {
        ...
        let response = try await client.tracking.cargoByDeviceTimeseries.dataPointsPublicV1(
            cargoId: "cargo_id",
            taskGroupId: "task_group_id",
            limit: 1,
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
