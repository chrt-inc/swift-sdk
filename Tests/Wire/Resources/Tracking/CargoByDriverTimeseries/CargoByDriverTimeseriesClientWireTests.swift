...
@Suite("CargoByDriverTimeseriesClient Wire Tests") struct CargoByDriverTimeseriesClientWireTests {
    @Test func lastSeenV11() async throws -> Void {
        ...
        let response = try await client.tracking.cargoByDriverTimeseries.lastSeenV1(
            cargoId: "cargo_id",
            taskGroupId: "task_group_id",
    ...
    @Test func dataPointsV11() async throws -> Void {
        ...
        let response = try await client.tracking.cargoByDriverTimeseries.dataPointsV1(
            cargoId: "cargo_id",
            taskGroupId: "task_group_id",
            limit: 1,
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
    ...
    @Test func lastSeenPublicV11() async throws -> Void {
        ...
        let response = try await client.tracking.cargoByDriverTimeseries.lastSeenPublicV1(
            cargoId: "cargo_id",
            taskGroupId: "task_group_id",
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
        )
    ...
    @Test func dataPointsPublicV11() async throws -> Void {
        ...
        let response = try await client.tracking.cargoByDriverTimeseries.dataPointsPublicV1(
            cargoId: "cargo_id",
            taskGroupId: "task_group_id",
            limit: 1,
            requestOptions: RequestOptions(additionalHeaders: stub.headers)
