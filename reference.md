...
<details><summary><code>client.operations.cases.<a href="/Sources/Resources/Operations/Cases/CasesClient.swift">getByOrderRefV1</a>(orderRef: String, requestOptions: RequestOptions?) -> Case1</code></summary>
<dl>
<dd>
...
private func main() async throws {
    ...
    _ = try await client.operations.cases.getByOrderRefV1(orderRef: "order_ref")
}
...
<details><summary><code>client.operations.cases.<a href="/Sources/Resources/Operations/Cases/CasesClient.swift">getByOrderShortIdV1</a>(orderShortId: String, requestOptions: RequestOptions?) -> Case1</code></summary>
<dl>
<dd>
...
private func main() async throws {
    ...
    _ = try await client.operations.cases.getByOrderShortIdV1(orderShortId: "order_short_id")
}
...
<details><summary><code>client.operations.cases.<a href="/Sources/Resources/Operations/Cases/CasesClient.swift">setBillingReviewStatusV1</a>(caseId: String, request: Requests.CaseSetBillingReviewStatusReq, requestOptions: RequestOptions?) -> Bool</code></summary>
<dl>
<dd>
...
private func main() async throws {
    ...
    _ = try await client.operations.cases.setBillingReviewStatusV1(
        caseId: "case_id",
...
**request:** `Requests.CaseSetBillingReviewStatusReq` 
...
<details><summary><code>client.operations.operationsTaskLists.<a href="/Sources/Resources/Operations/OperationsTaskLists/OperationsTaskListsClient.swift">setEntriesV1</a>(taskListId: String, request: Requests.OperationsTaskListSetEntries1, requestOptions: RequestOptions?) -> Bool</code></summary>
<dl>
<dd>
...
private func main() async throws {
    ...
    _ = try await client.operations.operationsTaskLists.setEntriesV1(
        taskListId: "task_list_id",
        request: .init()
    )
}
...
**request:** `Requests.OperationsTaskListSetEntries1` 
...
<details><summary><code>client.operations.operationsTaskLists.<a href="/Sources/Resources/Operations/OperationsTaskLists/OperationsTaskListsClient.swift">removeFromCaseV1</a>(taskListId: String, caseId: String, requestOptions: RequestOptions?) -> OperationsTaskListRemoveFromCaseRes1</code></summary>
<dl>
<dd>
...
private func main() async throws {
    ...
    _ = try await client.operations.operationsTaskLists.removeFromCaseV1(
        taskListId: "task_list_id",
        caseId: "case_id"
    )
}
...
**filterTag:** `String?` — Filter to tasks carrying ANY of these tags
...
private func main() async throws {
    ...
    _ = try await client.operations.cases.s3Objects.addV1(
        caseId: "case_id",
        request: .init(file: .init(data: Data("".utf8)))
    )
}
...
<details><summary><code>client.operations.cases.s3Objects.<a href="/Sources/Resources/Operations/Cases/S3Objects/CasesS3ObjectsClient.swift">deleteV1</a>(caseS3ObjectMetadataId: String, requestOptions: RequestOptions?) -> Bool</code></summary>
<dl>
<dd>
...
private func main() async throws {
    ...
    _ = try await client.operations.cases.s3Objects.deleteV1(caseS3ObjectMetadataId: "case_s3_object_metadata_id")
}
...
<details><summary><code>client.shipping.flights.<a href="/Sources/Resources/Shipping/Flights/FlightsClient.swift">getFlightLegsForTaskGroupV1</a>(taskGroupId: String, requestOptions: RequestOptions?) -> FlightInfoForTaskRes</code></summary>
<dl>
<dd>
...
<details><summary><code>client.shipping.flights.<a href="/Sources/Resources/Shipping/Flights/FlightsClient.swift">getFlightStatusForFlightLegV1</a>(flightLegId: String, requestOptions: RequestOptions?) -> FlightLeg1</code></summary>
<dl>
<dd>
...
<details><summary><code>client.shipping.flights.<a href="/Sources/Resources/Shipping/Flights/FlightsClient.swift">getFlightTrackForFlightLegV1</a>(flightLegId: String, requestOptions: RequestOptions?) -> FlightTrackRes</code></summary>
<dl>
<dd>
...
private func main() async throws {
    ...
    _ = try await client.shipping.orderDrafts.typeaheadV1(
        query: "query",
        limit: 1
    )
}
