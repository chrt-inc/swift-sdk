...
<details><summary><code>client.shipping.tasks.<a href="/Sources/Resources/Shipping/Tasks/TasksClient.swift">completeV1</a>(taskId: String, request: TaskCompleteReq?, requestOptions: RequestOptions?) -> Bool</code></summary>
<dl>
<dd>
